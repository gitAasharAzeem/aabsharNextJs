...
const ProductMoreProductsSection = () => {
    const products = [
        ...
        { image: 'smart-monitor.jpg', title: 'Smart Water Meter', description: 'Our Smart Water Meter monitors usage in real-time, detects leaks, and promotes efficient water management for cost savings and sustainability', button: 'Subscribe Now' },
